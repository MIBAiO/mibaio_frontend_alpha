...
const MotionSensor =(props) =>
{
    ...
    useEffect(() => {
        switch (dealItems[0].color) {
            case "white":
                setProductImages((_) => [
                    "images/product2/Cover-Sensor.png",
                    "images/product2/Widely-used.png",
                    "images/product2/Angle-detection.png",
                    "images/product2/Smallest.png",
                    "images/product2/Commercial-2.png",
                ]);
                setCurrentlyViewing("images/product2/Cover-Sensor.png");
                break;
            case "blue":
                setProductImages((_) => [
        ...
        <>
            ...
            <div className="container-fluid product-page">
                <div className="container mx-auto my-3">
                    ...
                    <div className="row">
                        <div className={"col-md-6  pt-5"}>
                            <div className="text-mobile d-none d-md-block">
                                ...
                                <div className="product-feature">
                                    <p>Microwave Motion Sensor</p>
                                    <p>Fits any existing Tubelight, LED, CFL bulb</p>
                                    <p>Upto 80W load capacity</p>
                                    <p>15±3 sec cutoff timer</p>
                                </div>
                                <div className="product-price my-5">
                                    <h5 className="price">MRP ₹499.00</h5>
                                    <p>Incl. all taxes</p>
                                </div>
                            </div>
                            ...
                            <a href="https://wa.me/919834163593?text=Hi%20I'm%20interested%20to%20purchase%20Motion%20Sensor">
                        ...
                        <div
                            ...
                            <div className="text-mobile d-block d-md-none">
                                ...
                                <div className="product-feature">
                                    <p>Motion sensor with Microwave technology</p>
                    ...
                    <div className="product-info mt-5">
                        ...
                        <p class="big">Introducing our state-of-the-art Motion Sensor, 
                        the ultimate solution to elevate your existing lighting system into 
                        a highly efficient, motion-activated setup. 
                        Utilizing advanced Microwave technology, our Motion Sensor offers 
                        unparalleled precision and reliability, surpassing traditional PIR (Passive Infrared) motion sensors. <br />
                        Upgrade your lighting system today with our advanced Motion Sensor and enjoy the perfect blend of convenience, efficiency, and security. Illuminate your life smarter and brighter!
                        </p>
                    </div>
                        ...
                        <div className="row pl-3">
                            <div className="col-md-10 d-flex mt-0 features-slide">
                                ...
                                <div className="features-card mr-2 border border-primary p-3 rounded-5">
                                    ...
                                    <p>Versatile Compatibility</p>
                                </div>
                                <div className="features-card mr-2 border border-primary p-3 rounded-5">
                                    <img src="/svg-icons/charge_icon.svg" alt="clock-icon" className="" />
                                    <p>Long lasting<br /> Performance</p>
                                </div>
                                <div className="features-card mr-2 border border-primary p-3 rounded-5">
            ...
            < div className="tabs" ref={specsRef} >
                ...
                <div id="tab-content1" className="tab-content">
                    <video
                        id="myvideo"
                        src="images/Motion-sensor-video.mp4"
                        style={{
                            width: "100%",
                            //marginBottom: "-5%",
                            // transitionDelay: " 1s",
                            ...
                            >
                                <div className="unit unit-spacing-1 align-items-center">
                                    ...
                                    <div className="unit-body">
                                        <h4>Superior Microwave Technology</h4>
                                    </div>
                                </div>
                                    ...
                                    <blockquote className="quote-light">
                                        <div className="quote-light-text">
                                            <ul className="list-marked list-marked_secondary">
                                                <li>
                                                Enhanced Precision: Unlike conventional PIR sensors, our Microwave technology 
                                                provides higher accuracy in motion detection, 
                                                ensuring your lights are activated precisely when needed.
                                                </li>
                                                <li>
                                                Wide Detection Range: Experience extensive coverage with our sensor's ability to
                                                detect motion through walls, glass, and other obstacles, making it perfect for any room or setting.
                                                </li>
                                            </ul>
                                        </div>
                                    </blockquote>
                            ...
                            >
                                <div className="item">
                                    <img
                                        ...
                                        src="images/product2/Angle-detection.png"
                                        alt="Sensor-angle-detection"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row row-50 justify-content-xl-between align-items-center flex-md-row-reverse">
                            ...
                            >
                                ...
                                <div className="block-4 offset-top-4">
                                    <p className="big">
                                        Fits easily to existing tubelights, bulbs etc
                                    </p>
                                    <blockquote className="quote-light">
                                        <div className="quote-light-text">
                                            <ul className="list-marked list-marked_secondary">
                                                <li>
                                                Versatile Compatibility: Works with all types of lighting fixtures, 
                                                including LED, CFL, and incandescent bulbs, making it an ideal upgrade for any home or office.
                                                </li>
                                                <li>
                                                Seamless Installation: Effortlessly integrate the Motion Sensor with your existing lighting system. 
                                                No need for complex wiring or professional assistance—our sensor is designed for quick and easy setup.
                                                </li>
                                            </ul>
                                        </div>
                                    </blockquote>
                            ...
                            >
                                <div className="item">
                                    <img
                                        src="images/product2/Widely-used.png"
                                        alt="Motion-Sensor-applications"
                                        style={{ width: "100%" }}
                                    />
                                </div>
                            </div>
                    ...
                    <div className="container">
                        <div className="row row-50 justify-content-xl-between align-items-center">
                                ...
                                <div className="block-4 offset-top-4">
                                    ...
                                    <blockquote className="quote-light">
                                        <div className="quote-light-text">
                                            <ul className="list-marked list-marked_secondary">
                                                <li>
                                                    Connect your favorite devices like tubelight and CFL, LED bulb to enjoy a
                            ...
                            >
                                <div className="item">
                                    <img
                                        src="images/product2/Smallest.png"
                                        alt="Smallest design picture"
                                        width="100%;"
                                    />
                                </div>
                            </div>
