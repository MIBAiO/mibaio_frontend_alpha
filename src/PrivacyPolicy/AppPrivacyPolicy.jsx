        ...
        <>
            ...
            <section className="section section-md container pt-4">
                <div className="container">
                    <h5 className='my-2'>Privacy Policy</h5>
                    <p className=''>
                    ...
                    <h5 className='my-2'>Information Collection and Use</h5>
                    <p className=''>
                    ...
                    <h5 className="my-2">Service Providers</h5>
                    <p>
                    ...
                    <p> If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at contact@mibaio.in</p>
                </div >
            </section >
