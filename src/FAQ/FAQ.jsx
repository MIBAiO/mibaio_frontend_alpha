            ...
            <section class="section section-md bg-gray-100">
                <div class="container">
                    <div
                        ...
                        id="tabs-faq"
                    >
                        {/* <Tab.Container className="stuck-navbar stuck-2 navbar">
                                ...
                                >
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    MIBAiO 4S enables control of
                                                    upto four appliances or
                                                    electric circuits. The
                                                    maximum rated current on
                                                    each load is 10A. All slots
                                                    can be used to turn on/off
                                                    appliances eg. lights, fan,
                                                    bulbs any 10A appliance.{" "}
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-title">
                                                ...
                                                >
                                                    {" "}
                                                    Would my existing physical
                                                    switches work after
                                                    installing MIBAiO 4S?
                                                    <div class="card-arrow"></div>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    Yes! Your existing physical
                                                    switches function as before.
                                                    When the appliances are
                                                    controlled manually using
                                                    physical switches, it
                                                    reflects immediately on the
                                                    app as well.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    No, MIBAiO 4S is WiFi +
                                                    Bluetooth enabled and
                                                    communicate directly with
                                                    your home Wi-Fi router and
                                                    doesn't require any
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-title">
                                                <a
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    Does MIBAiO 4S require
                                                    additonal or special wiring?
                                                    <div class="card-arrow"></div>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    No. MIBAiO 4S doesn't
                                                    require any kind of
                                                    additional wiring and can be
                                                    seamlessly integrated with
                                                    your switchboard panel.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    In case the Wi-Fi network
                                                    name or password is changed
                                                    the device will not be able
                                                    to connect back
                                                    automatically. You have to
                                                    get your MIBAiO device in to
                                                    setup mode and configure it
                                                    to the network. To get
                                                    MIBAiO 4S into setup mode,
                                                    press and hold the reset
                                                    button at the top of your
                                                    device for five seconds.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        >
                                            <div class="card-title">
                                                <a
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    Why does my MIBAiO 4S
                                                    occassionly get disconnected
                                                    from the network and doesn't
                                                    respond?
                                                    <div class="card-arrow"></div>
                                                </a>
                                            </div>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    using a dual-band routers,
                                                    ensure both the networks
                                                    have different SSID(network
                                                    name).
                                                    <br />
                                                    <br />
                                                    Please note: Traditional 2.4
                                                    GHz band gives a coverage
                                                    upto 150 ft indoors and 300
                                                    ft outdoors.
                                                    <br />
                                                    <br />
                                                    To solve the issue:
                                                    ...
                                                    connected devices are within
                                                    wireless network range. If
                                                    not, add an additional Wi-Fi
                                                    access point.
                                                    <br />
                                                    2. Reconnect your smart
                                                    devices to the Wi-Fi
                                                    network.
                                                    <br />
                                                    3. Access your router
                                                    settings and check if there
                                                    is any limit to the number
                                                    of simultaneous connections.
                                                    <br />
                                                    4. Update firmware to the
                                                    latest version on your
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    Bluetooth mode! Your app
                                                    will automatically shift to
                                                    bluetooth mode. If you are
                                                    in the range you can operate
                                                    your appliances from the app
                                                    using bluetooth and manual
                                                    switching as well.
                                                    <br />
                                                    First, ensure the Wi-Fi
                                                    network is working. In case
                                                    there is no problem with the
                                                    network, normal reset the
                                                    device and check if it
                                                    connected back. Even then,
                                                    if the problem persists,
                                                    factory reset the device and
                                                    configure the device again.
                                                    Get the Wi-Fi router closer
                                                    to the device or add a
                                                    repeater near to the device.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                >
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    lifestyle partner. With
                                                    MIBAiO you can easily
                                                    monitor, control and
                                                    automate your home from just
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    Control & monitor: You can
                                                    control or check the status
                                                    of connected electrical
                                                    appliances and lights from
                                                    the app. Perfect for those
                                                    times when you’re not sure
                                                    if the lights are left on or
                                                    the door is locked.
                                                    <br />
                                                    <br />
                                                    Scenes: With 'Scenes' you
                                                    control multiple appliances
                                                    with a tap in the app. For
                                                    Example, a “Good Night”
                                                    scene could be created to
                                                    turn off all the lights,
                                                    close the curtains, adjust
                                                    temperature on the AC to
                                                    your preference all at once.
                                                    <br />
                                                    <br />
                                                    Schedules: Want your lights
                                                    to turn on or off at
                                                    specific time of the say?
                                                    You can create a schedule
                                                    with in the app for single
                                                    or multiple devices to turn
                                                    to a specific setting for a
                                                    time of the day. Attend to
                                                    important things in your
                                                    life while MIBAiO takes care
                                                    of your home.
                                                    <br />
                                                    <br />
                                                    Location-Based Triggers:
                                                    With MIBAiO devices
                                                    installed, Your Home can
                                                    sense when you arrive or
                                                    leave and prepare itself as
                                                    per your preference. You can
                                                    automatically trigger
                                                    appliances and lights based
                                                    on your geo-location. You
                                                    can have all the house
                                                    lights & Air Conditioners
                                                    turn off once you cross a
                                                    pre-set distance say 500 m
                                                    from your home.
                                                    <br />
                                                    <br />
                                                    Add members: You can now
                                                    invite your family and
                                                    friends to share the joy of
                                                    connected living. It is as
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    MIBAiO currently supports
                                                    Android 5.0 or later and iOS
                                                    10.0 or later. The MIBAiO
                                        ...
                                        >
                                            <div class="card-title">
                                                <a
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    Can I access MIBAiO from my
                                                    computer, mobile web or
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    apps for Android Mobile and
                                                    Android wear. You can also
                                                    voice control all smart
                                                    products using Amazon Alexa,
                                                    Google Home, Siri or Bixby
                                                    powered devices. MIBAiO
                                                    products also can be
                                                    controlled from Home app on
                                                    iOS, Google Home and Alexa
                                                    Apps. You can also control
                                                    your devices from the Home
                                                    app on MacOS.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                >
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    Scenes enables control of
                                                    multiple appliances with
                                                    just a tap or a voice
                                                    command. They can be created
                                                    on the MIBAiO app. For
                                                    example, a "Good Night"
                                                    scene could be created to
                                                    turn off all the lights,
                                                    close the window curtains,
                                                    adjust the AC temperature to
                                                    your liking all at once.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    You can create a schedule
                                                    within the MIBAiO app for
                                                    single or multiple
                                                    appliances to turn on/off at
                                                    a time of the day. Attend to
                                                    more important activies in
                                                    your life while MIBAiO app
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    Yes, you can control,
                                                    monitor and automate all
                                                    your connected devices from
                                                    the MIBAiO app & supported
                                                    voice assistants from just
                                                    about anywhere in the world
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    When you controller device
                                                    (phone, tablet etc.) and
                                                    MIBAiO devices are connected
                                                    to the same Wi-Fi network,
                                                    they communicate with each
                                                    other with router acting as
                                                    a bridge. This is called
                                                    Local control.
                                                    <br />
                                                    When the app and MIBAiO
                                                    devices are not connected to
                                                    the same Wi-Fi network then
                                                    they communicate our secure
                                                    cloud servers and is called
                                                    remote control.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    MIBAiO App and devices do
                                                    not always require Wi-Fi to
                                                    connect and communicate with
                                                    each other.
                                                    <br />
                                                    <br />
                                                    This is the beauty of our
                                                    devices! In such cases you
                                                    can control your connected
                                                    appliances via Bluetooth
                                                    using the same smartphone
                                                    app. <br />
                                                    And even if you lose Wi-Fi
                                                    connection, you will still
                                                    be able to manually control
                                                    your devices. Once the Wi-Fi
                                                    network is restored, MIBAiO
                                                    devices will reconnect to
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-title">
                                                ...
                                                >
                                                    {" "}
                                                    Do I need pay subscription
                                                    fee to use MIBAiO app?
                                                    <div class="card-arrow"></div>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    No, MIBAiO app is completely
                                                    free to download & use. Even
                                                    control from the voice
                                                    assistants is free 😁
                                                </p>
                                            </div>
                                        </div>
                                ...
                                >
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    No, MIBAiO 4S is designed to
                                                    fit perfectly outside your
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-title">
                                                <a
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    How do I connect MIBAiO
                                                    devices to a new router or
                                                    what happens if I make
                                                    changes to my Wi-Fi network
                                                    name or password?
                                                    <div class="card-arrow"></div>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    You have to get MIBAiO
                                                    device to set-up mode. To
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    No, MIBAiO devices doesn't
                                                    require any additional or
                                                    special wiring and
                                                    seamlessly integrated with
                                                    your existing switchboards.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    MIBAiO products will connect
                                                    back and are available for
                                    ...
                                    <article class="card card-custom card-classic">
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    MIBAiO products will only
                                                    connect and work with 2.4
                                                    GHz network. In case you are
                                                    using dual-band routers
                                                    ensure both the networks
                                                    have different SSID (name)
                                                    or switch off the 5GHz band.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        >
                                            <div class="card-title">
                                                <a
                                                    ...
                                                    aria-expanded="false"
                                                >
                                                    If I encounter issues with a
                                                    MIBAiO product or app whom
                                                    should I contact?
                                                    <div class="card-arrow"></div>
                                                </a>
                                            </div>
                                        ...
                                        >
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    support@mibaio.xyz or call
                                                    us at +91 96736 60515.
                                                </p>
                                            </div>
                                        </div>
                                    </article>
