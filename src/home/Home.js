    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="page ">
                    <section className="section page-header-1 header-section" style={{background:"#434343"}}>
                                         ...
                                         <NavDropdown title="More" id="collasible-nav-dropdown">
                                            <NavDropdown.Item>
                                                <ul className="rd-navbar-megamenu-inner">
                                                    ...
                                                    <li className="rd-megamenu-list-item"><a className="rd-megamenu-list-link" href="careers.html">Careers</a></li>
                                                    <li className="rd-megamenu-list-item"><a className="rd-megamenu-list-link" href="#FAQ">FAQ</a></li>
                                                    </ul>
                                                </li>
                                                <li className="rd-megamenu-item">
                                                <ul className="rd-megamenu-list">
                ...
                <div className="box-custom-4-aside bg-accent">
                    <div className="box-custom-4-aside-decoration">
                        ...
                        <div className="box-custom-4-icon-outer"><span className="box-custom-4-icon"></span></div>
                    </div>
                    <div className="box-custom-4-aside-content wow fadeInRightSmall"  data-wow-delay=".8s">
                        <div className="iphone-frame-4-group">

                            <div id="carouselExampleSlidesOnly" className="carousel slide" data-ride="carousel" data-easing="ease-in-out" data-autoplay="true" data-autoplay-timeout="3500" data-mouse-drag="true">
                            ...
                            <div className="box-custom-4-main">
                                <div className="block-10">
                                    ...
                                    >
                                        ...
                                        >
                                            Upgrade your existing conventional electrical appliances to a set of smart appliances! Control & monitor from any part of the world with your smartphone!
                                        </p>
                                    </div>
                                    <div
                           ...
                           <section id="services" className="services section-md section-bg" style={{background:"linear-gradient(180deg, #434343, #000000)"}}>
                           <div className="container">   
                    {/* <section> */}
                    
                    <section>
                    <h2 className="offset-top-7 text-center font-weight-regular wow fadeInUp" style={{background: "linear-gradient(270deg, #63DDD1 0%, #1F2EB1 137.5%)",
                                    
                                    WebkitBackgroundClip:"text",
                                    WebkitTextFillColor:"transparent",
                                    backgroundClip:"text"}} data-wow-delay=".4s">Xtension 4S</h2>
                    <h5 className="text-center wow-animation wow fadeIn" data-wow-delay=".4s" style={{marginBottom:"20px",color:"#f1f1f1"}}>Designed to simplify your life</h5> 

                
                  <div className="row features-small mb-5 mt-3 wow fadeIn" data-wow-delay=".6s">
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="row">
                        <div className="col-2">
                          <i className="fas mdi mdi-router-wireless" style={{fontSize: "20px"}}></i>
                        </div>
                        <div className="col-10">
                          <h6 className="feature-title" style={{color: "#BDD4E7"}}>No Hub required</h6>
                          <p className="grey-text">Does not need any additional hub to connect to internet, works with any 2.4Ghz compatible WiFi router.
                          </p>
                      ...
                      <div className="row">
                        <div className="col-2">
                          <i className="mdi mdi-repeat-off" style={{fontSize: "20px"}}></i>
                        </div>
                        <div className="col-10">
                          <h6 className="feature-title" style={{color: "#BDD4E7"}}>No rewiring</h6>
                          <p className="grey-text">Does not need additional rewiring. Easy to install, plug and play!
                          </p>
                          <div style={{height:"15px"}}></div>
                        </div>
                      </div>
                    ...
                    <div className="col-md-4 flex-center">
                      <img src={sample1} alt="MIBAiO Xtension 4S white"
                        className="z-depth-0 img-fluid wow fadeInUp" data-wow-delay=".5s"/>
                    </div>
                    ...
                    <div className="col-md-4 mt-2">
                      ...
                      <div className="row">
                        <div className="col-2">
                          <i className="fas mdi 2x mdi-bluetooth-audio" style={{fontSize: "20px"}}></i>
                        </div>
                        <div className="col-10">
                          <h6 className="feature-title" style={{color: "#BDD4E7"}}>Dual Connectivity</h6>
                          <p className="grey-text">Bluetooth + WiFi hybrid mode ensures that it works flawlessly with and without internet.
                          </p>
                          <div style={{height:"15px"}}></div>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-2">
                          <i className="fas mdi 2x mdi-chart-line" style={{fontSize: "20px"}}></i>
                          
                        </div>
                        <div className="col-10">
                          <h6 className="feature-title" style={{color: "#BDD4E7"}}>Enerygy monitoring</h6>
                          <p className="grey-text">Monitor your energy consumption and estimate the cost of electricity bills.</p>
                          <div style={{height:"15px"}}></div>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6 col-lg-3 wow fadeInUp" data-aos="fade-up" data-wow-delay=".3s">
                        <div className="icon-box">
                            <div className="icon">
                                <a href="#Security">
                                    {/* <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script> */}
                                    <lord-icon src="https://cdn.lordicon.com/kbtmbyzy.json" trigger="loop" colors="primary:#ffffff,secondary:#4af0ba" speed=".7" style={{width:"50px",height:"50px"}}> 
                                    </lord-icon>
                                </a>
                            </div>
                            <h4 style={{color: "#BDD4E7"}}><a href="#Security">Automation</a></h4>
                            <p className="description">Schedule your appliances to turn on/off automatically at desired timing. Indivisually or simultaneously!🕖 </p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3 wow fadeInUp" data-aos="fade-up" data-wow-delay=".4s">
                        <div className="icon-box">
                            <div className="icon"><a href="#Voice">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon src="https://cdn.lordicon.com/fpipqhrr.json" trigger="loop" colors="primary:#ffffff,secondary:#4af0ba" speed=".7" stroke={58} style={{width:"50px",height:"50px"}}>
                                    </lord-icon>
                                </a></div>
                            <h4 style={{color: "#BDD4E7"}}><a href="#Voice">Voice Control</a></h4>
                            <p className="description">Relax yourself completely, 🗣 Let your voice do the job!<br/> <br/> <span style={{fontSize:" 12px", opacity:" .8"}}>(PS: Works with Alexa, Siri & Google)</span></p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3 wow fadeInUp" data-aos="fade-up" data-wow-delay=".5s">
                        <div className="icon-box">
                            <div className="icon"><a href="#MMC">
                                    <script src="https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js"></script>
                                    <lord-icon className="lord" src="https://cdn.lordicon.com/gaqzgxto.json" trigger="loop" colors="primary:#ffffff,secondary:#4af0ba" speed=".8" style={{width:"50px",height:"50px"}}>
                                    </lord-icon>
                                </a></div>
                            <h4 style={{color: "#BDD4E7"}}><a href="#MMC">Energy Efficient</a></h4>
                            <p className="description">Energy savings and advancements you never imagined! Save upto 26% of your energy biils! 💚 </p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3 wow fadeInUp" data-aos="fade-up" data-wow-delay=".6s">
                        <div className="icon-box">
                            <div className="icon">
                                <a href="#Surge">
                            ...
                            <h4  style={{color:"#BDD4E7"}}><a href="#Surge">Shared Access</a></h4>
                            <p className="description">Share devices with your family 👨‍👩‍👦, sync state of devices, set more smart scenes for any space.</p>
                        </div>
                    </div>
                </div>
                    </div>
                    ...
                    <picture>
                    <video style={{width:"100%", transitionDelay:"1s",marginBottom:"-6%"}} loop autoPlay muted playsInline>
                    ...
                    <h3 className="wow fadeInUp" data-wow-delay=".4s" style={{textAlign: "center" ,marginBottom: "50px",color: "#697484"}}>Our <span style={{color:"#0accbe"}}>most prominent </span>features</h3>

<div className="container" id="Surge">
    <div className="row row-50 justify-content-xl-between align-items-center">
        <div className="col-md-8 col-lg-7 col-xl-6 wow fadeInLeftSmall" data-wow-delay=".5s"> 
            ...
            <div className="block-4 offset-top-4">
                            ...
                            <blockquote className="quote-light">
                                <div className="quote-light-text">
                                    <p>MIBAiO Xtension 4S is equipped with a Positive Temperature Coefficient Thermister (PTC) to protect your electrical appliances from accidental voltage spikes in alternating current (AC) circuits  
                                    </p>
                                </div>
                            </blockquote>
                        </div>
            ...
            <div className="col-md-4 col-lg-5 wow fadeInRightSmall right-pattern" data-wow-delay=".6s">
                            <div className="item">
                                <img className="d-block w-100" src={surgeproof} alt="Surge-proof-Xtension4S" width="456" height="456" />
                            </div> 
                    </div>
            ...
            <div className="unit unit-spacing-1 align-items-center">
                        ...
                        <p className="big"></p>
                            <blockquote className="quote-light">
                            <div className="quote-light-text">
                                    <p>In addition to the conventional physical button switching, MIBAiO Smart app additionally enables you to remotely
                                        control your smart appliances with:
                                        <br/><br/>
                                    <div className="icon icon-style-1 mdi mdi-wifi"></div> Internet <br/><br/>
                                    <div className="icon icon-style-1 mdi mdi-bluetooth"></div> Bluetooth</p>
                                    <div className="group-buttons-responsive group-middle"><a className="button button-secondary button-winona" href="product.php">View All
                                            Features</a><a className="button button-default-outline button-winona" style={{color:"#0accbe"}} href="product.php">Learn More</a></div>
                                </div>
                            </blockquote>
            ...
            <div className="col-md-4 col-lg-5 wow fadeInLeftSmall left-pattern">
                        <img className="d-block w-100" src={modeposter} alt="AI Chip image"/>
                    </div>
...
<section
                        ...
                        >
                            ...
                            <div className="parallax-content">
                                <div className=" container context-dark">
                                    ...
                                    >
                                        <span style={{ maxWidth: "800px" }}>
                                        We are on a mission to transform the Smart Home Ecosystem in India <br/>And we invite you to take a front seat in this
                                        </span>
                                    </p>
                   ...
                   <section id="why-us" className="why-us section-bg1 wow fadeInUp">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="content">
                            <h3>How does MIBAiO <span style={{color:"#0accbe"}}>benefit you?</span></h3><br/>
                            <h5 style={{color:"#697484"}}>
                               Here's where we tell how MIBAiO Xtension 4S truely <span style={{color:"#4a80f0"}}>adds value</span> to your life!
                            </h5>
                        </div>
                        <br/>
                        ...
                        <div className="wrapper">
                            ...
                            <div className="accordion">
                                <div className="item">
                                    ...
                                    <h4  style={{fontSize:"20px",paddingLeft:"20px",paddingTop:"20px"}}> <span style={{color:"#0accbe"}}>01&nbsp; &nbsp;</span>Comfort</h4>
                                    <span>{selected == 1 ? '-' : '+'}</span>
                                    </div>
                                    
                                    <div className={selected == 1 ? 'content show' : 'content'}>
                                    Control and keep an eye on your electricals from anywhere<br/>Do it with your voice! or your fingertips.
                                    </div>
                                    </div>
                                    <div className="item">
                                    <div className="title" onClick={()=> toggle(2)}>
                                        <h4 style={{fontSize:"20px",paddingLeft:"20px",paddingTop:"20px"}}> <span style={{color:"#0accbe"}}>02&nbsp; &nbsp;</span>Convenience</h4>
                                     ...
                                     <div className="title" onClick={()=> toggle(3)}>
                                        <h4  style={{fontSize:"20px",paddingLeft:"20px",paddingTop:"20px"}}><span style={{color:"#0accbe"}}>03&nbsp; &nbsp;</span>ROI  [Return on Investment]?</h4>
                                        <span>{selected == 3 ? '-' : '+'}</span>
                                     </div>
                                     <div className={selected == 3 ? 'content show' : 'content'}>
                                     With uptp 26% savings on energy bills per month, you'll recover the amount invested roughly in about 7 months*..!
                                     </div>
                                     </div>
                    ...
                    <div className="col-lg-5 align-items-stretch order-1 order-lg-2 img" style={{backgroundImage:' url("images/Picture1.png")'}} data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
                        ...
                        <div className="parallax-content">
                            <div className="container context-dark">
                                ...
                                >
                                    ...
                                    <button
                                        className={"toggle-modern-switch content-toggle" + (toggleState && " active")}
                                        data-multitoggle="#pt-classic, #pt-classic-toggle"
                                        onClick={() => {
                                                        ...
                                                        <div className="pt-classic-header">
                                                            ...
                                                            <div className="pt-classic-price-outer">
                                                                ...
                                                                >
                                                                    ...
                                                                    <div style={{width:"70%",fontWeight:" 500", color: "#0accbe",background:" #d6f3f5",letterSpacing: "0.075em",fontSize:"20%",display:"flex",justifyContent:"center",alignItems:"center",height:"35px"}}>Save 20%</div>
                                                                    </div>
                    ...
                    <section id="FAQ" className="section section-md bg-gray-100 text-center wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div className="card-group-custom card-group-classic card-group-classic_1" role="tablist" aria-multiselectable="false">
                            ...
                            <article className="card card-custom card-classic">
                                ...
                                <div className="collapse" id="app-accordion-collapse-2" role="tabpanel" aria-labelledby="app-accordion-heading-2" data-parent="#app-accordion">
                                    <div className="card-body">
                                        <p>The major advantage is price: You get a premium model under ₹4000. You don’t
                                            have to call an
                        ...
                        <div className="card-group-custom card-group-classic card-group-classic_1" role="tablist" aria-multiselectable="false">
                            ...
                            <article className="card card-custom card-classic">
                                ...
                                <div className="collapse" id="app-accordion-collapse-5" role="tabpanel" aria-labelledby="app-accordion-heading-5" data-parent="#app-accordion">
                                    <div className="card-body">
                                        <p>Talk to your electrical appliances through Siri, Alexa and Google voice assistant. Control
                                            your exising
                                            appliances with your smartphone and also manually(like we do now using the
                                            conventional switches).
                                            Monitor your electricity consumption of
                                            connected appliances on your
                                            smartphone app.</p>
                                    </div>
                                </div>
                            </article>
        ...
        <section className="section section-md text-center">
            <div className="container"><span className="normal text-primary font-weight-bold text-uppercase wow fadeIn">lifestyle 2.0</span>
                <h3 className="offset-top-7 wow fadeIn" data-wow-delay=".1s">Step into the future, <span style={{color:"#0accbe"}}>Upgrade to MIBAiO</span></h3>
                <p className="wow fadeIn" data-wow-delay=".2s"><span style={{maxWidth: "720px",opacity:" .85"}}>It’s time to
                        upgrade
                        your home/office/workspace and experience the futuristic lifestyle! Contact us directly to enhance your lifestyle
                        experience.</span></p>
            </div>
            <div className="group"><a className="button button-default-outline button-winona text-black wow fadeIn" href="contact-us.html" data-wow-delay=".1s"><span></span>Contact us</a><a className="button button-secondary button-winona wow fadeIn" href="product.php" data-wow-delay=".1s"><span></span>Buy Now</a></div>
            </section>
